...
class HrLoan(models.Model):
    ...
    def default_get(self, field_list):
        ...
        return result
    @api.depends('loan_lines','loan_lines.paid','loan_lines.amount')
    def _compute_loan_amount(self):
        for loan in self:
            ...
            balance_amount = tot - total_paid
            loan.total_amount = tot
    ...
    loan_type = fields.Selection([('month','شهرية'),('installment','مقسطة')],default = 'month')
    loan_type_2 = fields.Selection(selection = [('type_1','سلف صندوق تكافل'),
                                                ('type_2','ِسلف اخري'),
                                                ('type_3','سلف شركة'),
                                               ])
    # @api.onchange('loan_type')
    # def _set_installment(self):
    #     self.installment = 1
