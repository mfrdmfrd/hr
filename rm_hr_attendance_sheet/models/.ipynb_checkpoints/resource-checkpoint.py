    ...
    def att_interval_clean(self, intervals):
        ...
        while intervals:
            ...
            if not working_interval:  # init
                working_interval = [current_interval[0], current_interval[1]] if len(current_interval) == 2 else [current_interval[0], current_interval[1],current_interval[4],current_interval[5]]
