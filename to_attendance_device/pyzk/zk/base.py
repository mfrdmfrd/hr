...
class ZK(object):
    ...
    def __decode_time(self, t):
        ...
        if month == 2 and day > 28:
            _logger.error('year' + str(year) + ' - month' + str(month) + ' - day' + str(day))
            _logger.error('t: ' + str(t))
            day = 28
